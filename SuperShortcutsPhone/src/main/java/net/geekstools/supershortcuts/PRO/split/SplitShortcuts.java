...
public class SplitShortcuts extends Activity implements View.OnClickListener, SimpleGestureFilterSwitch.SimpleGestureListener {
    ...
    protected void onCreate(Bundle Saved) {
        ...
        if (functionsClass.mixShortcuts() == true) {
            ...
            getActionBar().setSubtitle(Html.fromHtml("<small><font color='" + getResources().getColor(R.color.light) + "'>" + getString(R.string.maximum) + "</font>" + "<b><font color='" + getResources().getColor(R.color.light) + "'>" + PublicVariable.SplitShortcutsMaxAppShortcuts + "</font></b></small>"));
        } else {
